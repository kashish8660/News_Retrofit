        ...
        val itemTouchHelperCallback = object: ItemTouchHelper.SimpleCallback(
            ...
            override fun onSwiped(viewHolder: RecyclerView.ViewHolder, direction: Int) {
                ...
                Snackbar.make(view, "Successfully deleted article", Snackbar.LENGTH_LONG).apply {
                    //snackbar will give a chance to user to undo the deletion with "Undo" message
                    setAction("Undo"){
                        viewModel.saveArticle(article) //action to perform on clicking snackbar
                    }
                    show()
                }
            }
        }
        ItemTouchHelper(itemTouchHelperCallback).apply {//applying the ItemTouchHelper Created above
